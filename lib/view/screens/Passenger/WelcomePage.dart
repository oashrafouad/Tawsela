    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            CustomListTile(trailing: S.of(context).singInFaceBook, icon: Icons.facebook),
            CustomListTile(trailing: S.of(context).singInGoogle, icon: CustomGoogleIcon.google),
            CustomListTile(trailing: S.of(context).singInApple, icon: Icons.apple),
          ],
        ),
      ),
    );
